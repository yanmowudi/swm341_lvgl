...
void lv_port_disp_init(void)
{
    ...
    // static lv_color_t buf_3_1[HOR_RES * VER_RES]__attribute__((section(".SDRAM1")));            /*A screen sized buffer*/
    // static lv_color_t buf_3_2[HOR_RES * VER_RES]__attribute__((section(".SDRAM1")));            /*An other screen sized buffer*/
    // lv_disp_draw_buf_init(&draw_buf_dsc_3, buf_3_1, buf_3_2, HOR_RES * VER_RES);   /*Initialize the display buffer*/
