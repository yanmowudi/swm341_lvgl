...
void lv_port_disp_init(void)
{
    ...
    static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t buf_3_1[LV_HOR_RES_MAX * LV_VER_RES_MAX];            /*A screen sized buffer*/
    static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t buf_3_2[LV_HOR_RES_MAX * LV_VER_RES_MAX];            /*An other screen sized buffer*/
