...
static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t lcdbuf_gui[MY_DISP_HOR_RES * MY_DISP_VER_RES];
static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t lcdbuf_show[MY_DISP_HOR_RES * MY_DISP_VER_RES];
/**********************
 *      MACROS
 **********************/
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    ...
    DMA_initStruct.DstAddr = (uint32_t)&lcdbuf_gui[MY_DISP_HOR_RES * y_flush_act + x1_flush];
...
void DMA_Handler(void)
{
    if(DMA_CH_INTStat(DMA_CH0, DMA_IT_DONE))
    {
        ...
        else
        {
            ...
            DMA->CH[0].DST = (uint32_t)&lcdbuf_gui[MY_DISP_HOR_RES * y_flush_act + x1_flush];
